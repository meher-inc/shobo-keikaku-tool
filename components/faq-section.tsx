...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "現在は東京消防庁・大阪市消防局・横浜市消防局・名古屋市消防局・京都市消防局・福岡市消防局・札幌市消防局・川崎市消防局・神戸市消防局・さいたま市消防局・広島市消防局・仙台市消防局・千葉市消防局・北九州市消防局に正式対応しています。政令指定都市の様式に順次対応を進めています。対応エリア外は標準様式で出力されますので、ご利用前に管轄消防署の様式と照合することをお勧めします。",
  },
  {
